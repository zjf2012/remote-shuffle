...
public class DaosReaderSync extends TaskSubmitter implements DaosReader {
  ...
  private Map<DaosReader.BufferSource, Integer> bufferSourceMap = new ConcurrentHashMap<>();
  ...
  @Override
  public void register(DaosReader.BufferSource source) {
    bufferSourceMap.put(source, 1);
  }

  @Override
  public void unregister(DaosReader.BufferSource source) {
  ...
  public DaosReader.BufferSource
    ...
    DaosReader.BufferSource source = new BufferSourceSync(partSizeMap,
        config.copy(maxBytesInFlight, maxReqSizeShuffleToMem), metrics);
   ...
   * dedicated threads.
   */
  public class BufferSourceSync extends DaosReader.BufferSource {
    ...
    protected BufferSourceSync(DaosReader reader) {
