...
public class IOManagerSynctemp extends IOManager {
  ...
  private static final Logger logger = LoggerFactory.getLogger(IOManagerSynctemp.class);

  public IOManagerSynctemp(SparkConf conf, Map<String, DaosObject> objectMap) {
